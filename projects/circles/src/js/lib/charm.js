class Charm {
    ...
    tweenProperty(sprite, //Sprite object
    ...
    breathe(sprite, endScaleX = 0.8, endScaleY = 0.8,
    ...
    strobe(sprite, scaleFactor = 1.3, startMagnitude = 10, endMagnitude = 20,
